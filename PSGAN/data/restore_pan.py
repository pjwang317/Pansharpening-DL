...
if __name__ == "__main__":
    ...
    for i in range(1,101):
        # newMul='C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/psgan/data/test_sim/%d_pan.tif'%i
        # dataset=gdal.Open('C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/pansharpening/dataset/test_sim/%d_pan_t.tif'%i)
        
        newMul='C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/psgan/data/test_real2/%d_pan.tif'%i
