...
if __name__ == "__main__":
    ...
    for i in range(1,101):
        ...
        # # the output image dir
        # newMul = 'C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/psgan/data/test_sim2/%d_mul.tif' % i
        # newLR = 'C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/psgan/data/test_sim2/%d_lr.tif' % i
        # newLR_U = 'C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/psgan/data/test_sim2/%d_lr_u.tif' % i

        # # the dir of the image
        # dataset = gdal.Open('C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/pansharpening/dataset/test_sim/%d_mul_t.tif' % i)
        ...
        img_1=dataset.ReadAsArray()
        # print('img_1',img_1)
        # img=linear(img)
        mav = np.max(np.max((img_1)))
        minv = np.min(np.min((img_1)))
        print(mav,minv)
        img = (img_1-minv)/(mav-minv)*255
        # print(img)

        img_2 = img/255*(mav-minv)+minv
        ...
        # # blur_2 = scipy.ndimage.interpolation.zoom(img,(1./4),order=3,prefilter=False)
        # #img_blur = scipy.ndimage.interpolation.zoom(blur_2, 4,order=3,prefilter=False)
        ...
        # img_3 = img_blur/255*(mav-minv)+minv
