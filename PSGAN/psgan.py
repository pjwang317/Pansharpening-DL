...
parser.add_argument("--test_tfrecord", help="filename of test_tfrecord", default="C:/Users/USER-1/Documents/Peijuan/article/fromHocam/psgan/PSGan-master/data/psgan/test.tfrecords")
...
parser.add_argument("--save_freq", type=int, default=1000, help="save model every save_freq steps")
