...
with tf.Session() as sess:
    ...
    for step in range(300):
        ...
        if (step+1) % 50 ==0:
            save_path=saver.save(sess,"C:/Tools/Python/Python35/RemoteSensingEx/myCodes/training/newdata/parameter/PANCNN64net_noindices.ckpt")
            ...
            savemat('%s' % (step+1) + '_070964net_noidices_L1_1203.mat',{'W1':W1,'W2':W2,'W3':W3,'b1':b1,'b2':b2,'b3':b3})
